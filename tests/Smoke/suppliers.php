...
$assert( '2.0.0' === get_option( 'stockino_db_version' ) && $movement_rows === (int) $wpdb->get_var( $wpdb->prepare( 'SELECT COUNT(*) FROM %i', $movement_table ) ), 'The Phase 1 to Phase 2 migration preserves movement data and advances the schema version.' );
