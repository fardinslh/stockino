...
$category_variations = $request( 'GET', '/stockino/v1/inventory', array( 'category' => 'stockino-electronics', 'type' => 'variation', 'search' => 'Stockino Variable 110', 'per_page' => 100 ) )->get_data();
...
$low_variations = $request( 'GET', '/stockino/v1/inventory', array( 'category' => 'stockino-electronics', 'type' => 'variation', 'search' => 'Stockino Variable 110', 'low_stock' => true, 'per_page' => 100 ) )->get_data();
...
$global_low = $request( 'GET', '/stockino/v1/inventory', array( 'search' => 'STK-111', 'low_stock' => true ) )->get_data();
$assert( in_array( $global_id, array_column( $global_low['items'], 'id' ), true ), 'Low-stock filtering honors the global fallback threshold.' );
$unmanaged = $request( 'GET', '/stockino/v1/inventory', array( 'manage_stock' => false, 'search' => 'STK-110-P' ) )->get_data();
...
$all_low = $request( 'GET', '/stockino/v1/inventory', array( 'low_stock' => true, 'per_page' => 20 ) )->get_data();
...
$zero        = $request( 'POST', "/stockino/v1/products/{$product_id}/adjust-stock", array( 'mode' => 'delta', 'quantity' => 0, 'reason' => 'correction' ) );
...
$inherited = $request( 'POST', "/stockino/v1/products/{$inherited_id}/adjust-stock", array( 'mode' => 'delta', 'quantity' => 1, 'reason' => 'correction' ) );
...
$bulk      = $request( 'POST', '/stockino/v1/inventory/bulk-adjust', array( 'product_ids' => array( $product_id, $inherited_id ), 'quantity' => 1, 'reason' => 'correction' ) );
...
$filtered_csv = $request( 'GET', '/stockino/v1/inventory/export', array( 'category' => 'stockino-electronics', 'type' => 'variation', 'low_stock' => true ) )->get_data();
